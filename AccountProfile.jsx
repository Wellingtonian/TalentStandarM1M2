...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'http://shannon-mvp-st.australiaeast.cloudapp.azure.com:60002/profile/profile/getTalentProfile',
            headers: {
    ...
    updateAndSaveData(newValues, reload) {
        let newProfile = Object.assign({}, this.state.profileData, newValues)
        this.setState({
            profileData: newProfile
        }, () => this.saveProfile(reload))
    }
    ...
    saveProfile(reload) {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'http://shannon-mvp-st.australiaeast.cloudapp.azure.com:60002/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                            ...
                            <div className="profile">
                                <form className="ui form">
                                    <div className="ui grid">
                                        ...
                                        >
                                            <TalentStatus
                                                jobStatus={this.state.profileData.jobSeekingStatus || {}}
                                                updateProfileData={this.updateWithoutSave}
                                                saveProfileData={this.updateAndSaveData}
                                            />
                                        </FormItemWrapper>
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='http://shannon-mvp-st.australiaeast.cloudapp.azure.com:60002/profile/profile/updateProfilePhoto'
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'http://shannon-mvp-st.australiaeast.cloudapp.azure.com:60002/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'http://shannon-mvp-st.australiaeast.cloudapp.azure.com:60002/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Description'
                                            tooltip='A short summary and description summing up who you to prospective employers'
                                            hideSegment={true}
                                            noPadding={true}
                                        >
                                            <SelfIntroduction
