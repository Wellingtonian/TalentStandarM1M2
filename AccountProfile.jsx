...
export default class AccountProfile extends React.Component {
  constructor(props) {
    ...
    this.updateForComponentIdInBuilt =
      this.updateForComponentIdInBuilt.bind(this);
  }
  ...
  loadData() {
    ...
    $.ajax({
      url: "https://talentservicesprofile20211112131915.azurewebsites.net/profile/profile/getTalentProfile",
      headers: {
  ...
  updateForComponentIdInBuilt(componentId, newValues) {
    let data = {};
  ...
  saveProfile() {
    var cookies = Cookies.get("talentAuthToken");
    $.ajax({
      url: "https://talentservicesprofile20211112131915.azurewebsites.net/profile/profile/updateTalentProfile",
      headers: {
        Authorization: "Bearer " + cookies,
        "Content-Type": "application/json",
      },
                  ...
                  <div className="ui grid">
                    ...
                    >
                      <SocialMediaLinkedAccount
                        ...
                        controlFunc={this.updateForComponentIdInBuilt}
                    ...
                    >
                      <PhotoUpload
                        ...
                        updateProfileData={this.updateWithoutSave}
                        savePhotoUrl="https://talentserviceprofile.azurewebsites.net/profile/profile/updateProfilePhoto"
                        // savePhotoUrl='https://talentservicesprofile20211112131915.azurewebsites.net/profile/profile/updateProfilePhoto'
                      />
                    </FormItemWrapper>
                    {/* 
                    <FormItemWrapper
                    ...
                    >
                      <VideoUpload
                        ...
                        updateProfileData={this.updateWithoutSave}
                        saveVideoUrl={
                          "https://talentservicesprofile20211112131915.azurewebsites.net/profile/profile/updateTalentVideo"
                        }
                      />
                    </FormItemWrapper>
                    <FormItemWrapper
                    ...
                    >
                      <CVUpload
                        ...
                        updateProfileData={this.updateWithoutSave}
                        saveCVUrl={
                          "https://talentservicesprofile20211112131915.azurewebsites.net/profile/profile/updateTalentCV"
                        }
                      />
                    </FormItemWrapper> */}
                  </div>
