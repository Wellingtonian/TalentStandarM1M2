...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'http://shannon-mvp-st.australiaeast.cloudapp.azure.com:60002/profile/profile/getEmployerProfile',
            headers: {
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'http://shannon-mvp-st.australiaeast.cloudapp.azure.com:60002/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
